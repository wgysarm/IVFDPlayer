...
IVFDChart::IVFDChart(QWidget *parent)
	: QWidget(parent)
{
	initVariables();
}
...
void IVFDChart::initVariables()
{
    m_bUseAntialiasing=true;
    m_bShowHLine=true;
    m_bShowPoint=true;
    m_hLineClr=Qt::black;
    m_strTitle=QString::fromLocal8Bit("CPU¿ªÏú");
}

void IVFDChart::paintEvent(QPaintEvent *e)
{
    QPainter painter;
    painter.begin(this);
...
/*!
  ...
  The following is painting used private functions

  */

void IVFDChart::resetVariables(QPainter *painter)
{
...
void IVFDChart::drawBackground(QPainter *painter)
{
    painter->save();
...
void IVFDChart::drawBox(QPainter *painter)
{
    painter->save();
...
void IVFDChart::drawText(QPainter *painter)
{
    painter->save();
...
void IVFDChart::drawGraph(QPainter *painter)
{
    painter->save();
...
void IVFDChart::drawTitle(QPainter *painter)
{
    painter->save();
...
/*!
  ...
  */
void IVFDChart::addData(qreal data)
{
