...
public:    
    ...
    {
        QMessageBox::information(0,QString::fromLocal8Bit("提示"),info,QMessageBox::Ok);
    }
    ...
    {
        QMessageBox::critical(0,QString::fromLocal8Bit("错误"),info,QMessageBox::Ok);
    }
    ...
    static int ShowMessageBoxQuesion(QString info)
    {
        ...
        msg.addButton(QString::fromLocal8Bit("确定"),QMessageBox::ActionRole);
        msg.addButton(QString::fromLocal8Bit("取消"),QMessageBox::RejectRole);
    ...
    {
        return QMessageBox::question(0,QString::fromLocal8Bit("询问"),info,QMessageBox::Yes|QMessageBox::No);
    }
    ...
    {
        bool ok;
        return QInputDialog::getText(frm,QString::fromLocal8Bit("提示"),info,QLineEdit::Password,"",&ok);
    }
    ...
    static bool CopyFile(QString sourceFile, QString targetFile)
    {
        ...
        {
            int ret=QMessageBox::information(NULL,QString::fromLocal8Bit("提示"),QString::fromLocal8Bit("文件已经存在，是否替换？"),QMessageBox::Yes | QMessageBox::No);
